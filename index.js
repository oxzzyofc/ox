...
// OXZZY BOT CREATED BY MALVIN KING 🤴 
...
async function loadSession() {
    try {
        ...
        const megaFileId = config.SESSION_ID.startsWith('Vishnu~') 
            ? config.SESSION_ID.replace("Vishnu~", "") 
            : config.SESSION_ID;
...
async function connectToWA() {
    ...
    conn.ev.on('connection.update', async(update) => {
        ...
        console.log('[ 🧩 ] Plugins installed successfully ✅');
            ...
            console.log(chalk.green('[ 🤖 ] OXZZY BOT Connected ✅'));
            ...
            try {
                ...
                const botname = "OXZZY-BOT"; //add your name
                const ownername = "OXZZY"; // add your name
                const malvin = {
                    key: {
                    ...
                    message: {
                        newsletterAdminInviteMessage: {
                            ...
                            newsletterName: "OXZZY OFC 🪀", //add your bot name
                ...
                const username = `oxzzyofc`;
                const mrmalvin = `https://github.com/${username}`;

                const upMessage = `\`Oxzzy Bot Connected!\` ✅
...
// =====================================
    ...
    try {
        ...
        const king = ['917907389440', '263776388689', '263780934873'];
