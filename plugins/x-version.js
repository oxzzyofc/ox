...
malvin({
  ...
  try {
    ...
    const repoUrl = config.REPO || 'https://github.com/oxzzyofc/OXZZY-BOT';
    ...
    await conn.sendMessage(from, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          newsletterName: config.BOT_NAME ? `${config.BOT_NAME} Bot` : 'OXZZY-BOT',
          serverMessageId: 143
        }
      }
    }, { quoted: mek });
